...
public class FormEntrarConta extends javax.swing.JFrame {
    ...
    private void btEntrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEntrarActionPerformed
        ...
        if (numeroConta.isEmpty() || agencia.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Por favor, informe o número da conta e a agência.", "Erro", JOptionPane.ERROR_MESSAGE);
        ...
        if (conta != null) {
            ...
            JOptionPane.showMessageDialog(this, "Conta ou agência incorretos.", "Erro", JOptionPane.ERROR_MESSAGE);
            limpar();
        }
